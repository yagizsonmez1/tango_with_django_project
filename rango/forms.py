...
class CategoryForm(forms.ModelForm):
    ...
    class Meta:
    # Provide an association additional information on the form between the ModelForm and a model
        model = Category
        fields = ('name',)

class PageForm(forms.ModelFrom):
    ...
    class Meta:
        # Provide an association between the ModelForm and a model model = Page
